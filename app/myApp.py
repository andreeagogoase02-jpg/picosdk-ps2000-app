...
class StreamingDevice:
    def __init__(self, gather_values, sample_interval, potential_range=ps2000.PS2000_VOLTAGE_RANGE['PS2000_1V'], leading_wave='A', pretrigger = 4000):
...
# Start device
picoDevice = StreamingDevice(samples, sample_interval, potential_range=ps2000.PS2000_VOLTAGE_RANGE['PS2000_20V'], leading_wave=first_edge, pretrigger=pretrigger)
# Collect data
for i in range(0, 1):
    print("Gathering...")
    ...
    data = {
        "setup": { 
            ...
            "expected_pulse_width": expected_pulse_width,
